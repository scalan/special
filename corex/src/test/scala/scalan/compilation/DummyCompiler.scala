 ...
 */
class DummyCompiler[ScalanCake <: ScalanEx](_scalan: ScalanCake) extends Compiler(_scalan) {
  import scalan._
 ...
 */
class DummyCompilerWithPasses[ScalanCake <: ScalanEx](scalan: ScalanCake) extends DummyCompiler(scalan) {
