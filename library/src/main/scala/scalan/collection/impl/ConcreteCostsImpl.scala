...
trait ConcreteCostsDefs extends scalan.Scalan with ConcreteCosts {
  ...
  implicit case object ClosureCompanionElem extends CompanionElem[ClosureCompanionCtor] {
    ...
    protected def getDefaultRep = Closure
  }
  ...
  lazy val Closure: Rep[ClosureCompanionCtor] = new ClosureCompanionCtor {
  }
...
!!!("Cannot convert from Costed to CostedPair: missing fields List(l, r)")
    override def getDefaultRep = CostedPair(element[Costed[L]].defaultRepValue, element[Costed[R]].defaultRepValue)
    override lazy val tag = {
...
!!!("Cannot convert from Closure to ClosureBase: missing fields List(func)")
    override def getDefaultRep = ClosureBase(element[Env].defaultRepValue, constFun[(Env, Arg), Res](element[Res].defaultRepValue))
    override lazy val tag = {
      implicit val tagEnv = eEnv.tag
      implicit val tagArg = eArg.tag
      implicit val tagRes = eRes.tag
...
implicit val eRes = p._2.elem.eRange
  ...
  lazy val ClosureBase: ClosureBaseCompanionCtor = proxyClosureBaseCompanion(ClosureBaseRep)
...
!!!("Cannot convert from Costed to CostedFunc: missing fields List(envCost, func, costFunc)")
    override def getDefaultRep = CostedFunc(element[Costed[Env]].defaultRepValue, element[Closure[Env, Arg, Res]].defaultRepValue, element[Closure[Env, Arg, Long]].defaultRepValue)
    override lazy val tag = {
      implicit val tagEnv = eEnv.tag
      implicit val tagArg = eArg.tag
      implicit val tagRes = eRes.tag
  ...
  class CostedFuncIso[Env, Arg, Res](implicit eEnv: Elem[Env], eArg: Elem[Arg], eRes: Elem[Res])
    ...
    override def to(p: Rep[(Costed[Env], (Closure[Env, Arg, Res], Closure[Env, Arg, Long]))]) = {
      ...
      CostedFunc(envCost, func, costFunc)
    }
...
implicit val eRes = p._2.eRes
  ...
  lazy val CostedFunc: CostedFuncCompanionCtor = proxyCostedFuncCompanion(CostedFuncRep)
...
implicit val eRes = p.func.eRes
  ...
  case class CostedOptionCtor[T]
      (override val either: Rep[WEither[Long, Costed[T]]])
...
!!!("Cannot convert from Costed to CostedOption: missing fields List(either)")
    override def getDefaultRep = CostedOption(element[WEither[Long, Costed[T]]].defaultRepValue)
    override lazy val tag = {
  ...
  // state representation type
  type CostedOptionData[T] = WEither[Long, Costed[T]]
  ...
  class CostedOptionIso[T](implicit eT: Elem[T])
    ...
    override def from(p: Rep[CostedOption[T]]) =
      tryConvert[CostedOption[T], WEither[Long, Costed[T]]](eTo, eFrom, p, _safeFrom)
    override def to(p: Rep[WEither[Long, Costed[T]]]) = {
      val either = p
      CostedOption(either)
    }
    lazy val eFrom = element[WEither[Long, Costed[T]]]
  ...
  class CostedOptionCompanionCtor extends CompanionDef[CostedOptionCompanionCtor] with CostedOptionCompanion {
    ...
    @scalan.OverloadId("fromFields")
    def apply[T](either: Rep[WEither[Long, Costed[T]]]): Rep[CostedOption[T]] =
  ...
  lazy val CostedOption: CostedOptionCompanionCtor = proxyCostedOptionCompanion(CostedOptionRep)
...
!!!("Cannot convert from Costed to CostedCol: missing fields List(values, costs)")
    override def getDefaultRep = CostedCol(element[Col[Item]].defaultRepValue, element[Col[Long]].defaultRepValue)
    override lazy val tag = {
      implicit val tagItem = eItem.tag
  ...
  // state representation type
  type CostedColData[Item] = (Col[Item], Col[Long])
  ...
  class CostedColIso[Item](implicit eItem: Elem[Item])
    ...
    override def from(p: Rep[CostedCol[Item]]) =
      tryConvert[CostedCol[Item], (Col[Item], Col[Long])](eTo, eFrom, p, _safeFrom)
    override def to(p: Rep[(Col[Item], Col[Long])]) = {
      val Pair(values, costs) = p
      CostedCol(values, costs)
    }
    lazy val eFrom = pairElement(element[Col[Item]], element[Col[Long]])
  ...
  class CostedColCompanionCtor extends CompanionDef[CostedColCompanionCtor] with CostedColCompanion {
    ...
    @scalan.OverloadId("fromFields")
    def apply[Item](values: Rep[Col[Item]], costs: Rep[Col[Long]]): Rep[CostedCol[Item]] =
  ...
  lazy val CostedCol: CostedColCompanionCtor = proxyCostedColCompanion(CostedColRep)
...
!!!("Cannot convert from Costed to CostedPairCol: missing fields List(ls, rs)")
    override def getDefaultRep = CostedPairCol(element[Costed[Col[L]]].defaultRepValue, element[Costed[Col[R]]].defaultRepValue)
    override lazy val tag = {
      implicit val tagL = eL.tag
      implicit val tagR = eR.tag
...
implicit val eR = p._2.eVal.typeArgs("A")._1.asElem[R]
  ...
  lazy val CostedPairCol: CostedPairColCompanionCtor = proxyCostedPairColCompanion(CostedPairColRep)
...
!!!("Cannot convert from Costed to CostedNestedArray: missing fields List(rows)")
  ...
  case class CostedNestedColCtor[Item]
    ...
    override lazy val eVal: Elem[Col[Col[Item]]] = colElement(colElement(eItem))
  ...
  class CostedNestedColElem[Item](val iso: Iso[CostedNestedColData[Item], CostedNestedCol[Item]])(implicit val eItem: Elem[Item])
    extends CostedElem[Col[Col[Item]], CostedNestedCol[Item]]()(colElement(colElement(eItem)))
...
!!!("Cannot convert from Costed to CostedNestedCol: missing fields List(rows)")
    override def getDefaultRep = CostedNestedCol(colElement(costedElement(colElement(eItem))).defaultRepValue)
    override lazy val tag = {
      implicit val tagItem = eItem.tag
  ...
  class CostedNestedColIso[Item](implicit eItem: Elem[Item])
    ...
    override def to(p: Rep[Col[Costed[Col[Item]]]]) = {
      val rows = p
      CostedNestedCol(rows)
    }
    lazy val eFrom = colElement(costedElement(colElement(eItem)))
  ...
  lazy val CostedNestedCol: CostedNestedColCompanionCtor = proxyCostedNestedColCompanion(CostedNestedColRep)
  ...
  def mkCostedOption[T]
    (either: Rep[WEither[Long, Costed[T]]]): Rep[CostedOption[T]] = {
  ...
  def mkCostedCol[Item]
    (values: Rep[Col[Item]], costs: Rep[Col[Long]]): Rep[CostedCol[Item]] = {
