  ...
  case class CostedSomeCtor[T]
    ...
    override def filter(p: Rep[Costed[T => Boolean]]): Rep[Costed[WOption[T]]] = {
      asRep[Costed[WOption[T]]](mkMethodCall(self,
        ...
        List(p),
        true, false, element[Costed[WOption[T]]]))
    }
    ...
    override def flatMap[B](f: Rep[Costed[T => WOption[B]]]): Rep[Costed[WOption[B]]] = {
      ...
      asRep[Costed[WOption[B]]](mkMethodCall(self,
        ...
        List(f),
        true, false, element[Costed[WOption[B]]]))
    }
...
!!!("Cannot convert from CostedOption to CostedSome: missing fields List(costedValue)")
  ...
  class CostedSomeIso[T](implicit eT: Elem[T])
    ...
    override def transform(t: Transformer) = new CostedSomeIso[T]()(eT)
...
object CostedNone extends EntityObject("CostedNone") {
  ...
  class CostedNoneIso[T](implicit eT: Elem[T])
    ...
    override def transform(t: Transformer) = new CostedNoneIso[T]()(eT)
...
object CCostedOption extends EntityObject("CCostedOption") {
  case class CCostedOptionCtor[T]
      (override val value: Rep[WOption[T]], override val costOpt: Rep[WOption[Int]], override val sizeOpt: Rep[WOption[Long]], override val accumulatedCost: Rep[Int])
  ...
  class CCostedOptionElem[T](val iso: Iso[CCostedOptionData[T], CCostedOption[T]])(implicit override val eT: Elem[T])
    ...
    override def buildTypeArgs = super.buildTypeArgs ++ TypeArgs("T" -> (eT -> scalan.util.Invariant))
    override def convertCostedOption(x: Rep[CostedOption[T]]) = // Converter is not generated by meta
!!!("Cannot convert from CostedOption to CCostedOption: missing fields List(costOpt, sizeOpt, accumulatedCost)")
    override def getDefaultRep = RCCostedOption(element[WOption[T]].defaultRepValue, element[WOption[Int]].defaultRepValue, element[WOption[Long]].defaultRepValue, 0)
    override lazy val tag = {
      implicit val tagT = eT.tag
  ...
  // state representation type
  type CCostedOptionData[T] = (WOption[T], (WOption[Int], (WOption[Long], Int)))
  ...
  class CCostedOptionIso[T](implicit eT: Elem[T])
    ...
    override def from(p: Rep[CCostedOption[T]]) =
      tryConvert[CCostedOption[T], (WOption[T], (WOption[Int], (WOption[Long], Int)))](eTo, eFrom, p, _safeFrom)
    override def to(p: Rep[(WOption[T], (WOption[Int], (WOption[Long], Int)))]) = {
      val Pair(value, Pair(costOpt, Pair(sizeOpt, accumulatedCost))) = p
      RCCostedOption(value, costOpt, sizeOpt, accumulatedCost)
    }
    lazy val eFrom = pairElement(element[WOption[T]], pairElement(element[WOption[Int]], pairElement(element[WOption[Long]], element[Int])))
  ...
  class CCostedOptionCompanionCtor extends CompanionDef[CCostedOptionCompanionCtor] with CCostedOptionCompanion {
    ...
    @scalan.OverloadId("fromFields")
    def apply[T](value: Rep[WOption[T]], costOpt: Rep[WOption[Int]], sizeOpt: Rep[WOption[Long]], accumulatedCost: Rep[Int]): Rep[CCostedOption[T]] =
  ...
  def mkCCostedOption[T]
    (value: Rep[WOption[T]], costOpt: Rep[WOption[Int]], sizeOpt: Rep[WOption[Long]], accumulatedCost: Rep[Int]): Rep[CCostedOption[T]] = {
