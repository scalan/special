package special.collection {
  ...
  trait CostedOptions extends Base { self: Library =>
    ...
    trait CostedOption[T] extends ConcreteCosted[WOption[T]] {
      ...
      def getOrElse(default: Rep[Costed[Function0[T]]]): Rep[Costed[T]];
    ...
    abstract class CostedSome[T](val costedValue: Rep[Costed[T]]) extends CostedOption[T] {
      ...
      def getOrElse(default: Rep[Costed[Function0[T]]]): Rep[Costed[T]] = CostedSome.this.costedValue;
      @NeverInline def fold[B](ifEmpty: Rep[Costed[Function0[B]]], f: Rep[Costed[scala.Function1[T, B]]]): Rep[Nothing] = delayInvoke;
      ...
      @NeverInline def flatMap[B](f: Rep[Costed[scala.Function1[T, WOption[B]]]]): Rep[Nothing] = delayInvoke;
    ...
    abstract class CostedNone[T](val cost: Rep[Int])(implicit val eT: Elem[T]) extends CostedOption[T] {
      ...
      @NeverInline def getOrElse(default: Rep[Costed[Function0[T]]]): Rep[Nothing] = delayInvoke;
      @NeverInline def fold[B](ifEmpty: Rep[Costed[Function0[B]]], f: Rep[Costed[scala.Function1[T, B]]]): Rep[Nothing] = delayInvoke;
      def isEmpty: Rep[CostedPrim[Boolean]] = RCostedPrim(toRep(true.asInstanceOf[Boolean]), CostedNone.this.cost.+(CostedNone.this.builder.SelectFieldCost), toRep(1L.asInstanceOf[Long]));
      def isDefined: Rep[CostedPrim[Boolean]] = RCostedPrim(toRep(false.asInstanceOf[Boolean]), CostedNone.this.cost.+(CostedNone.this.builder.SelectFieldCost), toRep(1L.asInstanceOf[Long]));
      @NeverInline def filter(p: Rep[Costed[scala.Function1[T, Boolean]]]): Rep[Nothing] = delayInvoke;
      @NeverInline def flatMap[B](f: Rep[Costed[scala.Function1[T, WOption[B]]]]): Rep[Nothing] = delayInvoke;
      @NeverInline def map[B](f: Rep[Costed[scala.Function1[T, B]]]): Rep[Nothing] = delayInvoke
    };
